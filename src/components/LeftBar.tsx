...
//             {/* LOGO MENU BUTTON */}
//             <div className="flex felx-col gap-4 text-lg items-center xxl:items-start">
//                 {/* LOGO */}
...
//                     {menuList.map(item => (
//                         <Link href={item.link} className="p-2 rounded-full hover:bg-[#181818] flex item-center gap-4" key={item.id} >
//                             <Image src={`icons/${item.icon}`} alt={item.name} width={24} height={24} />
//                             <span className="hiddren xxl:inline">{item.name}</span>
//                         </Link>
//                     ))}
//                 </div>
//                 BUTTON
